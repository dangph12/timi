    ...
    <header className='flex items-center justify-between px-4 md:px-8 py-3 md:py-4 bg-white sticky top-0 z-50 shadow-sm'>
      ...
      <div className='absolute left-1/2 -translate-x-1/2'>
        <Link to="/" className='hover:opacity-80 transition-opacity flex items-center justify-center'>
          <img src="/timilogo.png" alt="tỉ mỉ logo" className="h-8 md:h-10 lg:h-12 w-auto object-contain" />
        </Link>
      </div>
      ...
      <div className='flex items-center gap-4 lg:gap-6'>
        <div className='flex items-center gap-3 lg:gap-5'>
          <button className='relative hover:text-pink-500 transition-colors group'>
            ...
            <span className='absolute -top-2 -right-2 bg-[#42d1d1] text-white text-[9px] font-black h-4 w-4 rounded-full flex items-center justify-center border-2 border-white group-hover:scale-110 transition-transform'>
              3
            </span>
          </button>
